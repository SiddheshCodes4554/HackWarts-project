...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 px-3 pb-3 sm:px-6 sm:pb-4">
      <div className="mx-auto max-w-xl rounded-[1.6rem] border border-white/70 bg-white/85 px-2 py-2 shadow-[0_18px_50px_rgba(22,163,74,0.14)] backdrop-blur-xl">
